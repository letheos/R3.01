...
--
-- Host: localhost:3306
-- Generation Time: Dec 08, 2023 at 08:41 AM
...
CREATE TABLE `dashboard` (
  `iddashboard` bigint(20) UNSIGNED NOT NULL,
...
--
-- Table structure for table `dashboarduser`
--
...
ALTER TABLE `dashboard`
  ...
  ADD UNIQUE KEY `iddashboard` (`iddashboard`);

--
-- Indexes for table `dashboarduser`
--
ALTER TABLE `dashboarduser`
...
--
ALTER TABLE `dashboard`
  MODIFY `iddashboard` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `dashboarduser`
--
ALTER TABLE `dashboarduser`
  MODIFY `iddashboard` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
